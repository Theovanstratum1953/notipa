...
urlpatterns = [
    ...
    path(
        "my-children/<uuid:pk>/report-cards/",
        views.my_child_report_cards,
        name="my_child_report_cards",
    ),
    ...
    path("terms/new/", views.term_new, name="term_new"),
    path("terms/<uuid:pk>/edit/", views.term_edit, name="term_edit"),
    path("terms/<uuid:pk>/delete/", views.term_delete, name="term_delete"),
    path("report-cards/", views.report_cards_classes_list, name="report_cards_classes"),
    path(
        "report-cards/classes/<uuid:pk>/",
        views.report_cards_roster,
        name="report_cards_roster",
    ),
    path(
        "report-cards/classes/<uuid:pk>/terms/<uuid:term_pk>/publish-all/",
        views.report_cards_publish_all,
        name="report_cards_publish_all",
    ),
    path(
        "report-cards/classes/<uuid:pk>/terms/<uuid:term_pk>/students/<uuid:student_pk>/",
        views.report_card_edit,
        name="report_card_edit",
    ),
    path("report-cards/<uuid:pk>/view/", views.report_card_view, name="report_card_view"),
    path("settings/", views.school_settings, name="settings"),
    path("exports/", views.export_panel, name="exports"),
    path("exports/download/", views.export_download, name="export_download"),
    path("exports/jobs/<uuid:pk>/download/", views.export_job_download, name="export_job_download"),
