...
urlpatterns = [
    ...
    path("attendance/", views.attendance_classes_list, name="attendance_classes"),
    path("attendance/overview/", views.attendance_overview, name="attendance_overview"),
    path("attendance/classes/<uuid:pk>/", views.attendance_roster, name="attendance_roster"),
